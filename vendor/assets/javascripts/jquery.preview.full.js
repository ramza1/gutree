...
function Selector(form, selector) {
  ...
  var Selector = {
    ...
    toPartials : function (obj) {
      ...
      } else if (obj.object && obj.object.type === 'photo_tips') {
...
function Display(display){
  ...
  var Display = {
    ...
    templates : {
      ...
      'rich' :  {
          ...
          'rich' : ['<div class="item rich">',
            ...
            '<div class="clearfix"></div>',
          '</div>'].join(''),
          'photo' : ['<div class="item photo_tips">',
            '<a class="title" href="{{original_url}}" target="_blank">{{title}}</a>',
            '{{>object}}',
            '<div class="attributes">',
              '<p class="description">{{description}}</p>',
    ...
    toPartials : function(obj){
      ...
      } else if (obj.object_type === 'photo_tips' || obj.type === 'image'){
    ...
    _callback : function (obj) {
      ...
      _.each(this.display_attrs, function (n) {
        ...
        // Set up the image URL for previews of the ful image.
          ...
          if (obj.hasOwnProperty('object') && obj.object.hasOwnProperty('type') && obj.object.type === 'photo_tips') {
            v = obj.object.url;
